export default function Footer() {
  return (
    <footer className="bg-noir border-t border-cream/5 py-12">
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          {/* Logo */}
          <a href="#" className="font-[var(--font-display)] text-lg tracking-[0.15em] text-gold">
            LP GOLD
          </a>

          {/* Links */}
          <div className="flex items-center gap-8 text-[11px] tracking-[0.12em] uppercase text-cream/25">
